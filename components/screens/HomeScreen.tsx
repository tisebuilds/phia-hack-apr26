...
import type { StarterMode } from "@/lib/types";

const HOME_MILESTONES: readonly { mode: StarterMode; label: string; hint: string }[] = [
  { mode: "work", label: "Work & milestones", hint: "Reviews, first weeks, client days" },
  { mode: "concert", label: "Show / night out", hint: "Gigs, venues, after-dark" },
  { mode: "campus", label: "Campus / school", hint: "Classes, club fair, everyday" },
  { mode: "halloween", label: "Halloween", hint: "Costume-forward, still wearable" },
  { mode: "workParty", label: "Office party", hint: "Work-adjacent, more fun" },
  { mode: "work", label: "Just browsing", hint: "General capsule, work lane" },
] as const;
...
export function HomeScreen({
  ...
  onPickMilestone: (mode: StarterMode) => void;
  onOpen: () => void;
      ...
      {tiles.map((t) => (
        <div
          ...
          style={{
            ...
            borderRadius: 12,
            padding: "7px 8px 9px",
            minHeight: "clamp(52px, 11svh, 72px)",
            display: "flex",
            flexDirection: "column",
        ...
        >
          <div
            ...
            aria-hidden
          >
            <t.Icon size={17} strokeWidth={iconStroke} aria-hidden />
          </div>
          <div style={{ minWidth: 0 }}>
            ...
            <div
              style={{
                fontFamily: "var(--font-sans), sans-serif",
                fontSize: "clamp(8px, 2.2vmin, 10px)",
        ...
        {!homeMilestoneChosen ? (
          <div
            style={{
              ...
              paddingTop: "clamp(18px, 4svh, 36px)",
              paddingBottom: 4,
            }}
          >
            <section aria-labelledby="home-milestone-heading">
              <h2
                id="home-milestone-heading"
                style={{
                  fontFamily: "var(--font-serif), serif",
                  fontSize: "clamp(22px, 5.5vmin, 28px)",
                  fontWeight: 400,
              ...
              >
                {HOME_MILESTONES.map((m) => (
                  <button
                    key={`${m.mode}-${m.label}`}
                    type="button"
                    onClick={() => onPickMilestone(m.mode)}
                    style={{
                      textAlign: "left",
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontFamily: "var(--font-sans), sans-serif",
                        fontSize: "clamp(12px, 3.1vmin, 14px)",
                        fontWeight: 600,
                        lineHeight: 1.2,
                        color: "#1a1a1a",
                      }}
